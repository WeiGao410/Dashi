...
public class YelpAPI {
    ...
    private static final String CONSUMER_KEY = "x2-3J8cxFe2ri4LwU-kxzQ";
    private static final String CONSUMER_SECRET = "KjqEISFrxoyTyfPAqgqpaAizCBI";
    private static final String TOKEN = "BH9BWtOEYPG8P-dd8vAdv-YkenMzJBYP";
    private static final String TOKEN_SECRET = "J9Q-jWpMrRWk25i9tmzLZKrhAb4";
